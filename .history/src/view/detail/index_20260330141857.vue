    ...
    <div class="goods-info">
      ...
      <div class="image-section">
        <div class="main-image">
          <img :src="detailinfo.mainPictures[0]" alt="" />
        </div>
        <div class="thumbnails">
          <div 
            v-for="(image, index) in detailinfo.mainPictures" 
            :key="index"
      ...
      <div class="detail-section">
        <!-- 商品名称 -->
        <h1 class="goods-name">{{ detailinfo.name }}</h1>
        ...
        <div class="goods-stats">
          ...
          <span class="stat-item">
            ...
            评价：{{ detailinfo.comments }}
          </span>
          <span class="stat-item">
            <i class="el-icon-star-on"></i>
            收藏：{{ detailinfo.favorites }}
          </span>
          <span class="stat-item">
...
onMounted(async () => {
  try {
    ...
    detailinfo.value = response.result;
